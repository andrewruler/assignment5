        ...
        <div className = "signin">
            ...
            <form>
                <div>       
                    ...
                    <input type="text" name="pass1" placeholder="Password" value = {pass1} onChange={(e) => setPass1(e.target.value)}></input>
                    <input type="text" name="pass2" placeholder="Confirm Password" value = {pass2} onChange={(e) => setPass2(e.target.value)}></input>
                    <button type = "submit" name = "submit" className = "submit" onClick = {(event) => handleSignIn(event)}>Sign In</button>
                </div>
            </form>
        </div>
    </>
